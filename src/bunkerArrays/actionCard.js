...
const actionCardArray = [
  ...
  "Взор императора<br /> С помощью этой карты можно заставить другого игрока повторить все факты о себе что он назвал ранее, но теперь ему нельзя врать",
  "Взор императора<br /> С помощью этой карты можно заставить другого игрока повторить один любой факт о себе что он назвал ранее, но теперь ему нельзя врать",
];
